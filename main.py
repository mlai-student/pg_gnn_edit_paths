...
from utils.generate_edit_paths import generate_pairwise_optimal_paths
...
if __name__ == '__main__':
    ...
    generate_pairwise_optimal_paths(graph_dataset, db_name=db_name, output_dir='data/')
    ...
    # create the intermediate graphs for the edit path using some valid random permutation of the operations
    edit_path_graphs = edit_paths[(0, 1)][0].create_edit_path_graphs(nx_graphs[0], nx_graphs[1])
